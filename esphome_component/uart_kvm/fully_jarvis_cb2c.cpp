            ...
            */
            ...
            void JarvisCB2CSensor::goto_height(double ht_in_cm)
            {
                  /*
                        ...
                        Instead, we must manually manipulate the GPIO to simular a user holding the up/down buttons
            ...
            bool JarvisCB2CSensor::verify_cb2c_checksum_(uint8_t *ptr)
            {
                  ...
                  // byte 3 is the number of paramaters
                  ...
                  // Checksum is the 8 bit sum of all bytes after the first 2 up to the paramaters.
