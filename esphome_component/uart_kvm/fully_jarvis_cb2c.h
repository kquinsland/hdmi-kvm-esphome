...
namespace esphome
{
  namespace fully_jarvis_cb2c
  {
    ...
    public:
      ...
      void set_active_bank_sensor(sensor::Sensor *sensor) { this->height_sensor_ = sensor; }
      void set_buzzer_status_sensor(sensor::Sensor *sensor) { this->height_sensor_ = sensor; }
